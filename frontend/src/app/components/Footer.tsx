                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between space-y-4 md:space-y-0">
                        <div className="text-center md:text-left">
                            ...
                            <p className="text-teal-100 text-xs sm:text-sm">Get the latest courses from experts.</p>
                        </div>
                        <div className="flex flex-col sm:flex-row gap-2 sm:gap-3 w-full md:w-auto">
                            ...
                            />
                            <button className="px-4 py-2 sm:px-6 sm:py-2.5 bg-blue-600 hover:bg-blue-700 text-white rounded-md transition-colors duration-200 whitespace-nowrap text-sm font-medium">
                                Subscribe
                            </button>
                        </div>
                    </div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 sm:py-4">
                    <div className="flex flex-col sm:flex-row items-center justify-between space-y-2 sm:space-y-0">
                        <p className="text-teal-200 text-xs sm:text-sm text-center sm:text-left">
                            © {currentYear} Course Platform. All rights reserved.
                        </p>
